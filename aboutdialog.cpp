    ...
    : QDialog(parent)
{
    ...
    if (!pm.isNull())
        pm = pm.scaled(180, 180, Qt::KeepAspectRatio, Qt::SmoothTransformation);
    ...
    subtitleLabel->setText(QString("<div style='color:#777'>Version %1</div>"
    ...
    credits->setHtml("<p><b>LazyMansClang</b> — a simple GUI front-end for clang++.</p>"
...
QString AboutDialog::buildInfo() const
{
    ...
    return QString("%1 (%2), %3, %4, built %5").arg(qtMajor, qtVer, LMC_COMPILER, archString(), when);
}
